    ...
    function n(J, R) {
        ...
        function aa(ao) {
            ...
            if (!a || (ai === R.fingers || R.fingers === f) || W()) {
                ...
                B = x();
                if (ai == 2) {
                    T[1].start.x = T[1].end.x = ap.touches[1].pageX;
                    T[1].start.y = T[1].end.y = ap.touches[1].pageY;
        ...
        function G(ao) {
            var aq = ao.originalEvent;
            if (F === g || F === m) {
                return
            }
            var an, am = a ? aq.touches[0] : aq;
            T[0].end.x = a ? aq.touches[0].pageX : am.pageX;
            T[0].end.y = a ? aq.touches[0].pageY : am.pageY;
            M = x();
            ...
            if (ai == 2) {
                if (af == 0) {
                    T[1].start.x = aq.touches[1].pageX;
                    T[1].start.y = aq.touches[1].pageY;
                    af = w = N(T[0].start, T[1].start)
                } else {
                    T[1].end.x = aq.touches[1].pageX;
                    T[1].end.y = aq.touches[1].pageY;
                    w = N(T[0].end, T[1].end);
        ...
        function O(ao) {
            var au = ao.originalEvent;
            if (au.touches && au.touches.length > 0) {
                return true
            }
            //ao.preventDefault();
            M = x();
